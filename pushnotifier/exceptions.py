...
UnsupportedMediaTypeError = Exception(
    "you passed an invalid file type or the device(s) you tried to send this image "
    "to can't receive images"
)

UnknownError = Exception(
    "an unknown error occurred! please contact the author of this module!"
)
